...
**🐘ガネーシャ：** 「うん、Lesson 8 で教えた通りやな。UseCase では throw するだけ」
...
| 最後のオーナーを削除しようとした | 「最低1人のオーナーが必要です」 |
...
| **11** | **カスタム例外** | **ConflictException で 409 を返す** |
